  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 pt-24 sm:pt-32 pb-16 sm:pb-20">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-20 min-h-[calc(100vh-12rem)]">
          <motion.div 
            className="flex-1 text-center lg:text-left max-w-3xl mx-auto lg:mx-0"
          ...
          >
            <motion.div
              ...
              className="mb-6"
            >
              <span className="inline-block px-4 py-2 bg-blue-500/20 text-blue-300 rounded-full text-sm font-medium backdrop-blur-sm border border-blue-400/20">
                Available for Hire
              </span>
            </motion.div>
            ...
            <motion.h2 
              className="text-xl sm:text-2xl md:text-3xl text-slate-300 mb-8 font-light leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                to="contact"
                smooth={true}
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-lg font-semibold cursor-pointer overflow-hidden transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/25 hover:-translate-y-1 text-center"
              >
              ...
              <Link
                to="projects"
                smooth={true}
                className="px-8 py-4 border-2 border-white/20 text-white rounded-lg font-semibold cursor-pointer backdrop-blur-sm hover:bg-white/10 hover:border-white/40 transition-all duration-300 hover:-translate-y-1 text-center"
              >
                View My Work
              </Link>
            </motion.div>
          ...
          >
            <div className="relative">
              ...
              <img
                ...
                className="relative rounded-full w-64 h-64 lg:w-80 lg:h-80 object-cover border-4 border-white/20 shadow-2xl"
              />
            </div>
          </motion.div>
        </div>
