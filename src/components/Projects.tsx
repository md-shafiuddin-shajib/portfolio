        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {projects.map((project, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="group bg-white/5 backdrop-blur-lg rounded-2xl overflow-hidden hover:bg-white/10 transition-all duration-300 border border-white/10 hover:border-white/20 hover:-translate-y-2 hover:shadow-2xl"
            >
              <div className="p-8">
                ...
                <p className="text-base text-gray-300 mb-6 leading-relaxed min-h-[120px]">
                  {project.description}
                </p>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {project.title.includes('Tour') && (
                    <>
                      ...
                      <span className="px-3 py-1 bg-purple-500/20 text-purple-300 rounded-full text-xs font-medium">MongoDB</span>
                    </>
                  )}
                  {project.title.includes('Food') && (
                    <>
                      <span className="px-3 py-1 bg-blue-500/20 text-blue-300 rounded-full text-xs font-medium">React.js</span>
                      <span className="px-3 py-1 bg-red-500/20 text-red-300 rounded-full text-xs font-medium">Redux</span>
